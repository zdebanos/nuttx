...
#define GPIO_HALLA_IN0 (GPIO_INPUT | GPIO_PORT_PIOC | GPIO_PIN17)
#define GPIO_HALLA_IN1 (GPIO_INPUT | GPIO_PORT_PIOC | GPIO_PIN11)
#define GPIO_HALLA_IN2 (GPIO_INPUT | GPIO_PORT_PIOC | GPIO_PIN10)
#define GPIO_HALLB_IN0 (GPIO_INPUT | GPIO_PORT_PIOD | GPIO_PIN13)
#define GPIO_HALLB_IN1 (GPIO_INPUT | GPIO_PORT_PIOD | GPIO_PIN14)
#define GPIO_HALLB_IN2 (GPIO_INPUT | GPIO_PORT_PIOD | GPIO_PIN17)
